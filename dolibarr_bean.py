...
class DolibarrBean(object):
    """
    This class represents a Dolibarr Bean.
    """

    def __init__(self, module, name_value_list=None, relationship_list=None, id='', relationship_name=''):
        self.module = module
        self._fields = {}
        self._fields['id'] = id
        if name_value_list:
    ...
    def _set_relationship_list(self, relationship_list):
        ...
        for record in relationship_list:
            record_map = {}
            for key_atribute, attribute_value in record.items():
                record_map[key_atribute] = attribute_value
            record_map['id'] = record['id']
            records.append(record_map)
        self._relationship_list[self._relationship_name.capitalize()] = records
